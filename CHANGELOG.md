...
- 首页产品预览更新为高清的真实 Execute 工作区截图，以工作、学习和日常生活组成完整的一天；切换中英文时会同步展示对应语言的界面与示例内容。
...
- The homepage product preview now uses high-resolution screenshots of the real Execute workspace, showing a full day across work, study, and everyday life, with matching interface and sample content when switching between English and Chinese.
