...
- Inverted the top-left product mark in dark mode while preserving its light and dark details, and gave the filled quick-add ADD button roomier proportions and the same squircle corners as the workspace.
